Feature: Datahen
  In order to develop scraper for Datahen
  As a CLI
  I want to write and test parsers locally


  Scenario: scraper parse
    When I run `datahen scraper parse ruby index.rb www.ebay.com-b3cc6226318ba6ba8e4a268341490fb35df24f141d95d9ebfccf8ffdd86ab364`
